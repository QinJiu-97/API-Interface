...
import static com.qinJiu.project.constant.UserConstant.ADMIN_ROLE;
import static com.qinJiu.project.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "qinjiu";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            String accessKey = DigestUtil.md5Hex(SALT + userAccount+ RandomUtil.randomString(3));
